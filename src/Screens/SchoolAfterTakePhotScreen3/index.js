...
class SchoolAfterTakePhotScreen3 extends Component {
  state = {
    formData: '',
    takenImage: '',
  };
  ...
  componentDidMount() {
    console.log(
      'formData from submit form in SchoolAfterTakePhotScreen3',
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <Text
                ...
                Group Photo Pose 3 of 3 uploaded!
              </Text>
              <View
                style={{
                  borderRadius: 500,
                ...
                <CustomButton
                  ...
                  onAction={() =>
                    this.props.navigation.navigate('CameraSectionScreen', {
                      fromdata: 'SchoolAfterTakePhotScreen3',
                      formData: formData,
                    })
                  }
                  width="100%"
...
export default SchoolAfterTakePhotScreen3;
