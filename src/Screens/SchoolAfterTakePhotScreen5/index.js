...
class SchoolAfterTakePhotScreen5 extends Component {
  state = {
    formData: '',
    takenImage: '',
  };
  ...
  componentDidMount() {
    console.log(
      'formData from submit form in SchoolAfterTakePhotScreen5',
                ...
                <CustomButton
                  ...
                  onAction={() =>
                    this.props.navigation.navigate('CameraSectionScreen', {
                      fromdata: 'SchoolAfterTakePhotScreen5',
                      formData: formData,
                    })
                  }
                  width="100%"
...
export default SchoolAfterTakePhotScreen5;
