...
const Demo = (props) => {
    ...
    const {icon, label, label2, navigateTo, noSign, name, changeScreen, closeModal } = props;

    return(
        <SafeAreaView style={{flex : 1,backgroundColor : '#000000d9',justifyContent : 'center', alignItems : 'center'}}>
            <StatusBar backgroundColor = "#fff" barStyle = "dark-content" />
                <View style={{backgroundColor : '#323AE4', width : '90%', height : '75%', borderRadius : 27, }}>                    
                    <TouchableOpacity 
                        onPress={()=>closeModal? closeModal() : changeScreen&&changeScreen(true)}
                        style={{left : 10, top : 10, width : 40, height : 40, justifyContent : 'center', alignItems : 'center'}}>
                    ...
                    <View style={{flex :1,justifyContent : 'space-evenly', alignItems : 'center',}}>
                        ...
                        <View style={{ height : '60%', justifyContent : 'center', alignItems : 'center', width : '100%', }}>
                            <Image 
                                source = {icon&&icon} 
                                style={{
                                    width : PixelRatio.getPixelSizeForLayoutSize(280/PixelRatio.get()), 
                                    height : PixelRatio.getPixelSizeForLayoutSize(265/PixelRatio.get())}}
                            />
                            ...
                            <View>
                                ...
                                <Text 
                                    style={{
                                        ...
                                        flexDirection : 'row',
                                        color : '#FFFFFF',
                                        fontSize : RFPercentage(32)/7,//RFPercentage(5.5),//32,//PixelRatio.getPixelSizeForLayoutSize(32),
                                ...
                                <Text 
                                    style={{
                                        ...
                                        flexDirection : 'row',
                                        color : '#FFFFFF',
                                        fontSize : RFPercentage(32)/7,//32+5,
                                        fontFamily : 'TTCommons-Bold', 
                                        textAlign : 'center',
                                        textAlignVertical : 'center',                                
                                        justifyContent : 'center',
                        ...
                        <View 
                            ...
                            <TouchableOpacity 
                                ...
                                style = {{padding : 10}}>
                                <Text style={CommonStyles.txtPrimary}>{name === 'demo3'? "Let's go": 'Next'}</Text>
                            </TouchableOpacity>                                                   
