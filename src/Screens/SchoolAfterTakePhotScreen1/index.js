...
class SchoolAfterTakePhotScreen1 extends Component {
  state = {
    formData: '',
    takenImage: '',
  };
  ...
  componentDidMount() {
    console.log(
      'formData from submit form in SchoolAfterTakePhotScreen1',
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <Text
                ...
                Group Photo Pose 1 of 3 uploaded!
              </Text>
              <View
                style={{
                  borderRadius: 500,
                ...
                <CustomButton
                  ...
                  onAction={() =>
                    this.props.navigation.navigate('CameraSectionScreen', {
                      fromdata: 'SchoolAfterTakePhotScreen1',
                      formData: formData,
                    })
                  }
                  width="100%"
...
export default SchoolAfterTakePhotScreen1;
