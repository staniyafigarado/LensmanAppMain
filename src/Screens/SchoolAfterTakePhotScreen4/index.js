...
class SchoolAfterTakePhotScreen4 extends Component {
  state = {
    formData: '',
    takenImage: '',
  };
  ...
  componentDidMount() {
    console.log(
      'formData from submit form in SchoolAfterTakePhotScreen4',
                ...
                <CustomButton
                  ...
                  onAction={() =>
                    this.props.navigation.navigate('CameraSectionScreen', {
                      fromdata: 'SchoolAfterTakePhotScreen4',
                      formData: formData,
                    })
                  }
                  width="100%"
...
export default SchoolAfterTakePhotScreen4;
